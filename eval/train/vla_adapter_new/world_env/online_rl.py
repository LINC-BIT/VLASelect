...
DEFAULT_OUTPUT_DIR = "train/vla_adapter_new/world_env/outputs/online_rl"
    ...
    for update in range(start_update, num_updates + 1):
        ...
        if use_train_success_only():
            ...
            if success_once >= best_success_once:
                ...
                save_training_checkpoint(
                    output_dir / "best_policy.pt", raw_policy, optimizer,
                    update, global_step, best_success_once,
                )
        ...
        reached_zero_success_stop, _ = reference.should_early_stop_zero_success(
            metrics_history,
