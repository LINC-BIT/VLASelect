...
BACKBONE_LEARNING_RATE="${MAPPO_BACKBONE_LEARNING_RATE:-8e-5}"
HEAD_LEARNING_RATE="${MAPPO_HEAD_LEARNING_RATE:-8e-5}"
STATE_LEARNING_RATE="${MAPPO_STATE_LEARNING_RATE:-8e-5}"
VALUE_HEAD_LEARNING_RATE="${VALUE_HEAD_LEARNING_RATE:-8e-5}"
WEIGHT_DECAY="${WEIGHT_DECAY:-1e-7}"
CLIP_EPS="${MAPPO_CLIP_EPS:-0.1}"
TARGET_KL="${MAPPO_TARGET_KL:-0.1}"
