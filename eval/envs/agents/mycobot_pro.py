...
@register_agent()
class MyCobot_Pro(BaseAgent):
    uid = "mycobot_pro"
    urdf_path = Path(__file__).parent.resolve() / f'urdfs/mycobot_pro/mycobot_630_gripper.urdf'
    ...
    def _controller_configs(self):
        ...
        arm_pd_joint_pos = PDJointPosControllerConfig(
            ...
            lower=[-3.14, -3.14, -3.14, -3.14, -2.99, -3.03],
            upper=[3.14159, 3.14, 3.14, 3.14, 2.99, 3.0368],
        ...
        gripper_pd_joint_pos = PDJointPosMimicControllerConfig(
            ...
            # lower = [-0.7, -0.8, -0.5, -0.3, -0.5, -0.5],
            # upper = [0.3,  0.5, 0.5, 0.7, 0.8, 0.5],
            lower = [-0.7, -0.5, -0.5],
            upper = [0.3, 0.5, 0.5],
