...
![VLA-adapter](./imgs/3.1.1.png)

### 3.1.2 Supporting different scaling strategies

![Scaling strategies](./imgs/3.1.2.png)
...
![TinyVLA](./imgs/3.2.1.png)

### 3.2.2 Supporting different scaling strategies

![Scaling strategies](./imgs/3.2.2.png)
...
![EdgeVLA](./imgs/3.3.1.png)

### 3.3.2 Baseline Comparison on EdgeVLA

![Baseline Comparison](./imgs/3.3.2.png)

### 3.3.3 Swapping Granularity Ablation on EdgeVLA

![Swapping Granularity Ablation](./imgs/3.3.3.png)