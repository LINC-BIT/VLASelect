...
env_settings_1 = dict(
    ...
    object_color=[0, 0, 1, 1],                              # 物体颜色，输入一个 RGBA 列表，None 表示随机选择，各维度 0 ~ 1 之间
...
def parse_args():
    ...
    parser.add_argument("--task-name", type=str, default="PickObjectRandomDofbot-v1")
    ...
    parser.add_argument("--robot-name", type=str, default="dofbot_se")
