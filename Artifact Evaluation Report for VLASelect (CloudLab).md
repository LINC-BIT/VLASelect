# Artifact Evaluation Report (An Academic Cloud Machine CloudLab): VLASelect<img src="./heading-divider.svg" alt="" width="100%" height="1">

In this report, we reproduce all the experiments in the VLASelect paper following the step-by-step instructions in [README](./README.md). All experiments were conducted on CloudLab using the minimal working examples.

## Outline

- [Artifact Evaluation Report (CloudLab): VLASelect](#artifact-evaluation-report-cloudlab-vlaselect)
  - [Outline](#outline)
...
| Subsystem | Platform in VLASelect Paper (Full Run) | CloudLab Platform (Minimal Working Example) |
| :---: | :---: | :---: |
| Operating System | Ubuntu 20.04/22.04 LTS (Kernel 5.4/5.15) | Ubuntu 22.04.2 LTS (Kernel 5.15) |
| CPU Architecture | 2 × Intel Xeon Gold 6430 (64C) | AMD EPYC 7542 (32C) |
| System Memory | 128 GB DDR5 | 512 GB DDR4 |
| GPU & VRAM | NVIDIA A100 80GB (+ Edge AGX) | NVIDIA Tesla V100 (32 GB) |
| CUDA Toolchain | Driver 550.144.03, CUDA 12.4 | Driver 580.173.02, CUDA 13.0 |
...
| Minimal Working Example | 7 minutes | 12 GB |
