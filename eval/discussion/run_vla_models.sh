...
SHORT_NUM_ENVS=${VLA_APPLICABILITY_NUM_ENVS:-4}
...
SHORT_ROLLOUT_MICRO_BATCH_SIZE=${VLA_APPLICABILITY_ROLLOUT_MICRO_BATCH_SIZE:-4}
SHORT_EVAL_MICRO_BATCH_SIZE=${VLA_APPLICABILITY_EVAL_MICRO_BATCH_SIZE:-4}
