...
@register_env("PickCube-v1-mutable", max_episode_steps=50)
class PickCubeEnvMutable(BaseEnv):
    ...
    def __init__(self, *args, robot_uids="panda", robot_init_qpos_noise=0.02, **kwargs):
        ...
        # self.cube_color = [1, 0, 0, 1]

        # if 'cube_half_size' in kwargs:
        #     self.cube_half_size = kwargs['cube_half_size']
        # if 'cube_color' in kwargs:
        #     self.cube_color = kwargs

        self.cube_color = [0, 0, 1, 1]
...
PickCubeEnvMutable.__doc__ = PICK_CUBE_DOC_STRING.format(robot_id="Panda")
