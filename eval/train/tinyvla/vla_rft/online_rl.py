...
DEFAULT_OUTPUT_DIR = "train/tinyvla/vla_rft/outputs/online_rl"
DEFAULT_WORLD_MODEL_CHECKPOINT = ""
DEFAULT_FBS_POLICY_CHECKPOINT = "ckpt/tinyvla/ours/outputs/bc_open_cabinet_drawer_fbs/20260508-032529/best_policy.pt"
...
def build_static_student_policy(args: Args, device: torch.device, env_id: str) -> reference.EdgeVLAActorCritic:
...
def train(args: Args) -> None:
    ...
    args = configure_env_contract(replace(args, env_id=current_env_id), device)
