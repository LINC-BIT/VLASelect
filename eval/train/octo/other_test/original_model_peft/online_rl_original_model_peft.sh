DATE=$(date +"%Y-%m-%d")
TIME=$(date +"%H-%M-%S")
LOG_DIR="train/octo/other_test/original_model_peft/nohup_out/$DATE"
...
PYTHON_CMD=(
    python -u -m train.octo.other_test.original_model_peft.online_rl_original_model_peft
