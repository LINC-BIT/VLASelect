...
LOG_FILE="$LOG_DIR/$TIME-pretrain-with-fbs-bc.log"
...
TEACHER_CHECKPOINT=${TEACHER_CHECKPOINT_OVERRIDE:-ckpt/vla_adapter_new/model_impl/outputs/ppo_hold_cube_in_hand/20260430-103518/best_policy.pt}
