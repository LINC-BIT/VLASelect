...
# BACKBONE_LEARNING_RATE="${MAPPO_BACKBONE_LEARNING_RATE:-3.5e-4}"
# HEAD_LEARNING_RATE="${MAPPO_HEAD_LEARNING_RATE:-3.5e-4}"
# STATE_LEARNING_RATE="${MAPPO_STATE_LEARNING_RATE:-3.5e-4}"
# VALUE_HEAD_LEARNING_RATE="${VALUE_HEAD_LEARNING_RATE:-3.5e-4}"
# WEIGHT_DECAY="${WEIGHT_DECAY:-1e-7}"
# CLIP_EPS="${MAPPO_CLIP_EPS:-0.4}"
# TARGET_KL="${MAPPO_TARGET_KL:-1.0}"
BACKBONE_LEARNING_RATE="${MAPPO_BACKBONE_LEARNING_RATE:-3e-4}"
HEAD_LEARNING_RATE="${MAPPO_HEAD_LEARNING_RATE:-3e-4}"
STATE_LEARNING_RATE="${MAPPO_STATE_LEARNING_RATE:-3e-4}"
VALUE_HEAD_LEARNING_RATE="${VALUE_HEAD_LEARNING_RATE:-3e-4}"
WEIGHT_DECAY="${WEIGHT_DECAY:-1e-7}"
CLIP_EPS="${MAPPO_CLIP_EPS:-0.4}"
TARGET_KL="${MAPPO_TARGET_KL:-5}"
...
MAX_TIME="${MAPPO_MAX_TIME:-${MAX_TIME:-}}"
