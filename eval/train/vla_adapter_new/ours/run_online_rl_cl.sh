...
LARGE_AGENT_CHECKPOINT=${LARGE_AGENT_CHECKPOINT_OVERRIDE:-ckpt/vla_adapter_new/ours/outputs/20260502-112804/best_policy.pt}
NUM_ENVS=${NUM_ENVS_OVERRIDE:-32}
