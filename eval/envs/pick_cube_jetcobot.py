...
from envs.agents.jetcobot import JetCobot
...
@register_env("PickCubeJetCobot-v1", max_episode_steps=50)
class PickCubeEnv(BaseEnv):
    SUPPORTED_ROBOTS = [
        "jetcobot",
    ]
    agent: Union[JetCobot]
    goal_thresh = 0.025
    cube_spawn_half_size = 0.05
    cube_spawn_center = (0, 0)

    def __init__(self, *args, robot_uids="jetcobot", robot_init_qpos_noise=0.02, **kwargs):
...
PickCubeEnv.__doc__ = PICK_CUBE_DOC_STRING.format(robot_id="jetcobot")
