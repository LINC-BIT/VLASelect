...
from train.multi_agents.two_robot_pick.tiny_vla import SharedTinyVLA4DActor
...
class MultiAgentVLAMAPPOAgent(nn.Module):
    def __init__(
        self,
...
def build_optimizer(args, agent: MultiAgentVLAMAPPOAgent) -> torch.optim.Optimizer:
    param_groups = [
        {
