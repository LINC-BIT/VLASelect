"""VLA-Adapter implementation of :class:`api.vla_model_interface.VLAModelInterface`."""
...
from api.update_impact_on_large_model.unified_online_rl import parse_args, run_training
from api.update_impact_on_large_model._reference_adapter import VLAAdapterImplementation, make_vla_adapter
...
def main() -> None:
    args = parse_args()
    run_training(make_vla_adapter(), args, resolve_small_model_interface(args))
