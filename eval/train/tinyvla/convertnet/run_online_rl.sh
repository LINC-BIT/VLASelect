...
LOG_FILE="$LOG_DIR/$TIME-tinyvla-convertnet-online-rl-cl.log"
OUTPUT_DIR_BASE_DEFAULT="train/tinyvla/convertnet/outputs/online_rl_cl"
...
LARGE_AGENT_CHECKPOINT=${LARGE_AGENT_CHECKPOINT_OVERRIDE:-ckpt/tinyvla/ours/outputs/bc_open_cabinet_drawer_fbs/20260508-032529/best_policy.pt}
ENV_ID=${ENV_ID_OVERRIDE:-OpenCabinetDrawerCabinet1021Default-v1}
ENVS_ID=${ENVS_ID_OVERRIDE:-"['OpenCabinetDrawerCabinet1021Default-v1','OpenCabinetDrawerCabinet1016ScaleUp1p3-v1','OpenCabinetDrawerCabinet1027Default-v1','OpenCabinetDrawerCabinet1016ScaleUp1p3-v1','OpenCabinetDrawerCabinet1032Default-v1','OpenCabinetDrawerCabinet1033ScaleUp1p3-v1','OpenCabinetDrawerCabinet1027Default-v1','OpenCabinetDrawerCabinet1021Default-v1','OpenCabinetDrawerCabinet1032Default-v1','OpenCabinetDrawerCabinet1033ScaleUp1p3-v1']"}
