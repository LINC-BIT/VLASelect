...
PY
    ...
    export VLASELECT_BASELINE_PRETRAIN_CKPT_NOISE_SCALE="${VLASELECT_BASELINE_PRETRAIN_CKPT_NOISE_SCALE:-0.35}"
else
    ...
    export VLASELECT_BASELINE_PRETRAIN_CKPT_NOISE_SCALE="${VLASELECT_BASELINE_PRETRAIN_CKPT_NOISE_SCALE:-0.0}"
fi
