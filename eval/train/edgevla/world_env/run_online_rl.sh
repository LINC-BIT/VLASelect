...
WORLD_ENV_DIR="train/edgevla/world_env"
...
WORLD_MODEL_CKPT=${WORLD_MODEL_CKPT_OVERRIDE:-${WORLD_MODEL_CHECKPOINT_OVERRIDE:-${WORLD_MODEL_CKPT:-}}}
...
PYTHON_CMD=(
    ...
    --static-model-checkpoint ckpt/edgevla/ours/outputs/bc_unitree_g1_lift_apple_fbs/20260511-171959/best_policy.pt
