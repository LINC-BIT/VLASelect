# Artifact Evaluation Checklist (Available, Functional, Reproduced)
...
<table style="width: 100%; table-layout: fixed;">
<thead><tr><th width="60%">Checklist Item</th><th width="40%">Our Artifact</th></tr></thead>
<tbody><tr><td>For instance, whether parts of the raw data were anonymized or discarded</td><td>✅<br>We do not anonymize or discard any raw data, as stated in <a href="https://github.com/LINC-BIT/VLASelect#127-about-dataset">Section 1.2.7 in README.md</a>.</td></tr></tbody>
</table>
<br>
...
<thead><tr><th width="60%">Checklist Item</th><th width="40%">Our Artifact</th></tr></thead>
<tbody>
<tr><td>Run and extend a “minimal working example”</td><td>✅<br>We provide 19 minimal working example in <a href="https://github.com/LINC-BIT/VLASelect#2-evaluation-reproduction">Section 2 in README.md</a> and <a href="https://github.com/LINC-BIT/VLASelect#3-supporting-various-vla-models-scaling-strategies-and-knowledge-exchange-granularities">Section 3 in README.md</a>. Running them can reproduce evaluation and verify VLASelect's applicability.</td></tr>
...
<table style="width: 100%; table-layout: fixed;">
<thead><tr><th width="60%">Checklist Item</th><th width="40%">Our Artifact</th></tr></thead>
<tbody><tr><td>Authors are encouraged, but not required, to provide inputs, configurations, and outputs for all experiments described in the paper.</td><td>✅<br>1. We pack the inputs and configurations into the scripts.<br>2. We provide example running outputs of each script in <a href="https://github.com/LINC-BIT/VLASelect#2-evaluation-reproduction">Section 2 in README.md</a> and <a href="https://github.com/LINC-BIT/VLASelect#3-supporting-various-vla-models-scaling-strategies-and-knowledge-exchange-granularities">Section 3 in README.md</a>.</td></tr></tbody>
</table>
<br>
...
<thead><tr><th width="60%">Checklist Item</th><th width="40%">Our Artifact</th></tr></thead>
<tbody>
<tr><td>The scripts must be documented, allowing researchers to ensure they correspond to the claims, merely producing the right output is not enough.</td><td>✅<br>We provide each script's documentation, example running outputs, and key observations in <a href="https://github.com/LINC-BIT/VLASelect#2-evaluation-reproduction">Section 2 in README.md</a> and <a href="https://github.com/LINC-BIT/VLASelect#3-supporting-various-vla-models-scaling-strategies-and-knowledge-exchange-granularities">Section 3 in README.md</a>.</td></tr>
...
<thead><tr><th width="60%">Checklist Item</th><th width="40%">Our Artifact</th></tr></thead>
<tbody>
<tr><td>For simple results presentation such as tables, this and the previous script can be merged into one.</td><td>✅<br>The result presentation for one experiment only requires one script, as listed in <a href="https://github.com/LINC-BIT/VLASelect#2-evaluation-reproduction">Section 2 in README.md</a> and <a href="https://github.com/LINC-BIT/VLASelect#3-supporting-various-vla-models-scaling-strategies-and-knowledge-exchange-granularities">Section 3 in README.md</a>.</td></tr>
...
<tr><td>In the absence of problems requiring debugging, active time must not exceed a few minutes.</td><td>✅<br>The minimum working example on each method takes 6-10 minutes to complete, as listed in <a href="https://github.com/LINC-BIT/VLASelect#2-evaluation-reproduction">Section 2 in README.md</a> and <a href="https://github.com/LINC-BIT/VLASelect#3-supporting-various-vla-models-scaling-strategies-and-knowledge-exchange-granularities">Section 3 in README.md</a>.</td></tr>
</tbody>
</table>
