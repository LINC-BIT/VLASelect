...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICES nohup python -u -m train.octo.ours_single_agent.online_rl \
    ...
    --tag ours-single-agent-targetsingletraj-feedif0.2-regen_per_rollout_0.1_4-small_policy-feedback0.1-arch_update0.05-reset_optimizer \
    --max_time 61 \
    > "$LOG_FILE" 2>&1 &
