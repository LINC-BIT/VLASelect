...
OUTPUT_DIR_BASE_DEFAULT="train/edgevla/vla_rft/outputs/online_rl"
...
PYTHON_CMD=(
    ...
    --fbs-policy-checkpoint ckpt/edgevla/ours/outputs/bc_unitree_g1_lift_apple_fbs/20260511-171959/best_policy.pt
