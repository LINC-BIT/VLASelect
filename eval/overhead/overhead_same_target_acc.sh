...
TABLE_ROOT="${TABLE_ROOT_OVERRIDE:-overhead/overhead_same_target_acc_table}"
...
ACC_COMPAT_TABLE_ROOT="${ACC_COMPAT_TABLE_ROOT_OVERRIDE:-acc_comparison/acc_task_env_from_same_target_acc_table}"
...
SAME_ACC_METHOD_ACTIVE_RUNTIME_SECONDS="${SAME_ACC_METHOD_ACTIVE_RUNTIME_SECONDS:-120}"
TARGET_ACCURACY="${TARGET_ACCURACY:-0.5}"
ACC_COMPAT_FIGURE_STEM="${ACC_COMPAT_FIGURE_STEM:-FIG_ACC_TASK_ENV_FROM_TARGET_ACC}"
ACC_COMPAT_SUMMARY_STEM="${ACC_COMPAT_SUMMARY_STEM:-acc_task_env_from_target_acc_summary}"
...
if [[ ! "$TARGET_ACCURACY" =~ ^(0|0\.[0-9]+|1(\.0+)?)$ ]]; then
    echo "TARGET_ACCURACY must be between 0 and 1 (received: $TARGET_ACCURACY)" >&2
    exit 2
fi
export TARGET_ACCURACY
if [[ "$MWE" == "1" ]]; then
    EDGEVLA_SMOKE="1"
    MONITOR_INTERVAL_SECONDS="${MONITOR_INTERVAL_SECONDS:-5}"
...
TINYVLA_ENVS_ID="${TINYVLA_ENVS_ID:-['OpenCabinetDrawerCabinet1021Default-v1','OpenCabinetDrawerCabinet1027Default-v1','OpenCabinetDrawerCabinet1016ScaleUp1p3-v1','OpenCabinetDrawerCabinet1016ScaleUp1p3-v1','OpenCabinetDrawerCabinet1032Default-v1','OpenCabinetDrawerCabinet1033ScaleUp1p3-v1','OpenCabinetDrawerCabinet1027Default-v1','OpenCabinetDrawerCabinet1021Default-v1','OpenCabinetDrawerCabinet1032Default-v1','OpenCabinetDrawerCabinet1033ScaleUp1p3-v1']}"
...
python overhead/plot_overhead_target_acc.py \
