...
LOG_FILE="$LOG_DIR/$TIME-improv-vla-unitree-g1-lift-apple.log"
OUTPUT_DIR_BASE=${OUTPUT_DIR_BASE_OVERRIDE:-"train/edgevla/improv_vla/outputs"}
...
WARMUP_SUCCESS_STEPS_BEFORE_SUPERVISED=${WARMUP_SUCCESS_STEPS_BEFORE_SUPERVISED_OVERRIDE:-0}
