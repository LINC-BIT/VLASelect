...
import train.tinyvla.conrft.online_rl as algo
...
DEFAULT_OUTPUT_DIR = "train/edgevla/conrft/outputs"
...
DEFAULT_TEACHER_CHECKPOINT = (
    "ckpt/edgevla/env_verify/outputs/ppo_unitree_g1_lift_apple/20260511-063605/best_policy.pt"
)
...
def configure_human_defaults() -> None:
    ...
    algo.DEFAULT_TEACHER_CHECKPOINT = DEFAULT_TEACHER_CHECKPOINT
    ...
    defaults = {
        ...
        "teacher_checkpoint": DEFAULT_TEACHER_CHECKPOINT,
