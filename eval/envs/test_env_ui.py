...
@dataclass
class Args:
    env_id: Annotated[str, tyro.conf.arg(aliases=["-e"])] = "PickObjectRandomDofbot-v1"
...
def main(args: Args):
    ...
    while True:
        ...
        action = np.zeros(env.action_space.shape) if env.action_space is not None else None
