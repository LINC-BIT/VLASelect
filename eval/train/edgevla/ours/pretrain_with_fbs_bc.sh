...
OURS_DIR="train/edgevla/ours"
LOG_DIR="$OURS_DIR/nohup_out/$DATE"
LOG_FILE="$LOG_DIR/$TIME-pretrain-with-fbs-bc-unitree-g1-lift-apple.log"
OUTPUT_DIR_BASE="$OURS_DIR/outputs/bc_unitree_g1_lift_apple_fbs"
...
TEACHER_CHECKPOINT=${TEACHER_CHECKPOINT_OVERRIDE:-auto}
