...
LOG_FILE="$LOG_DIR/$TIME-hold-cube-in-hand-l2.log"
OUTPUT_DIR_BASE="train/vla_adapter_new/model_impl/outputs/ppo_hold_cube_in_hand_l2"
...
PYTHON_CMD=(
    ...
    --mode train
    --seed 1
    --env-id HoldCubeInHandLevel2-v1
