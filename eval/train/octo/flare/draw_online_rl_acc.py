...
def draw_success_curve(run_dir: Path, output: Path, tag: str = "eval/success_at_end", title: str = "FLaRe Success Curve"):
    tb_dir = run_dir / "tb"
...
def main():
    ...
    parser.add_argument("--title", type=str, default="FLaRe Success Curve")
