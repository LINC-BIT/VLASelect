...
NUM_ENVS=${NUM_ENVS_OVERRIDE:-${NUM_ENVS:-64}}
...
RANDOM_INPUT_ROOT=${RANDOM_INPUT_ROOT_OVERRIDE:-train/octo/vla_rft/smoke_inputs}
...
PYTHON_CMD=(
    python -u forgetting/training/vla_rft/online_rl.py
    --env-id "$ENV_ID"
    --envs-id "$ENVS_ID"
